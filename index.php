...
<body>
    ...
    <table>
        ...
        <tr>
            <td><strong><?php echo $a = 0; ?></td>
            <td><strong><?php echo $b = 0; ?></td>
            <td><?php echo (!$a)?(!$a):var_dump(!$a) ?></td>
            <td><?php echo ($a || $b)?($a || $b):var_dump($a || $b) ?></td>
            <td><?php echo ($a && $b)?($a && $b):var_dump($a && $b) ?></td>
            <td><?php echo ($a xor $b)?($a xor $b):var_dump($a xor $b) ?></td>
        </tr>
        <tr>
            <td><strong><?php echo $a = 0; ?></td>
            <td><strong><?php echo $b = 1; ?></td>
            <td><?php echo (!$a)? (!$a):var_dump(!$a) ?></td>
            <td><?php echo ($a || $b)?($a || $b):var_dump($a || $b) ?></td>
            <td><?php echo ($a && $b)?($a && $b):var_dump($a && $b) ?></td>
            <td><?php echo ($a xor $b)?($a xor $b):var_dump($a xor $b) ?></td>
